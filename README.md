...
```
python3 -m pip install -r nonprofit-skills-library/scripts/requirements.txt
...
```
python3 nonprofit-skills-library/scripts/check_review_status.py         # list records needing attention
...
python3 nonprofit-skills-library/scripts/check_review_status.py --as-of YYYY-MM-DD  # fixed date for reproducible checks
```
